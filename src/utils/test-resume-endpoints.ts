...
export const testResumeEndpoints = () => {
  ...
  // Test 4: Re-analyze resume mutation
  const reanalyzeResume = reanalyzeApiV1Resumes_ResumeId_ReAnalyzePost();
  ...
  return {
    ...
    reanalyzeResume: (resumeId: string) => {
      ...
      reanalyzeResume.mutate({ resume_id: resumeId });
    }
  };
};
