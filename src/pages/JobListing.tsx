...
import { 
  ...
  reanalyzeApiV1Resumes_ResumeId_ReAnalyzePost,
  // Job API imports
...
const JobListing = () => {
  ...
  const { mutate: reanalyzeResume } = reanalyzeApiV1Resumes_ResumeId_ReAnalyzePost();
  ...
  const handleResumeReanalyze = (resumeId: string) => {
    reanalyzeResume({ resume_id: resumeId }, {
      onSuccess: () => {
                      ...
                      <div key={resume.id} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => handleResumeReanalyze(resume.id)}
                            className="flex items-center gap-2"
                          >
                    ...
                    <div className="text-center py-12">
                      ...
                      <div className="flex gap-2 justify-center">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => selectedResumeId && handleResumeReanalyze(selectedResumeId)}
