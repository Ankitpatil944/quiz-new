        ...
        <div className="relative max-w-7xl mx-auto  pt-16 lg:pt-20">
          ...
          {/* <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 justify-center relative mb-24 lg:mb-0">
              ...
              <div
                className="inline-flex items-center justify-center px-8 py-3 pl-6 pr-6 text-xs lg:text-lg bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-2xl font-medium transition-colors cursor-pointer hover:scale-105"
        ...
        <div className="text-center pt-14 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <Button 
              ...
              size="lg" 
              onClick={() => navigate('/signup')}
              className="px-8 py-3 text-lg rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white transition-colors duration-800"
            >
              Sign Up
            </Button>
          </div>
